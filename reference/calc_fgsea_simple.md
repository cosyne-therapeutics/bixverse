...
Rust-based version of the fgsea simple algorithm. This one is
permutation- based and similar to the traditional implementation, but
leverages some clear tricks to be way faster, see Korotkevich, et al.
